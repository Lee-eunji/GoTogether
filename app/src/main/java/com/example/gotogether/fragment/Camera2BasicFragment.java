package com.example.gotogether.fragment;
...
import com.example.gotogether.view.AutoFitTextureView;
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if(afAvailableModes.length ==0 || (afAvailableModes.length == 1
                        && afAvailableModes[0] == CameraMetadata.CONTROL_AE_ANTIBANDING_MODE_OFF)) {
