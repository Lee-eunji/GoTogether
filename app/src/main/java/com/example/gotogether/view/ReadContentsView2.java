package com.example.gotogether.view;
...
public class ReadContentsView2 extends LinearLayout {
    ...
    private void initView(){
        ...
        layoutInflater.inflate(R.layout.view_report, this, true);
    }
    ...
    public void setReportInfo(ReportInfo reportInfo){
        ...
        createdAtTextView.setText(new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(reportInfo.getCreatedAt()));
